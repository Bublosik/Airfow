...
def pipeline() -> None:
    df = pd.read_csv('C:/Users/User/airflow_hw\data/train/homework.csv')
    ...
    best_pipe.fit(X, y)
    model_filename = f'C:/Users/User/airflow_hw/data/models/cars_pipe_{datetime.now().strftime("%Y%m%d%H%M")}.pkl'
